...
contract ZuvuFunds is ReentrancyGuard, Ownable {
    ...
    function forward_funds(uint256 totalAmount, uint256[] memory splits, address[] memory recipients)
        public
        onlyOwner
        nonReentrant
    {
    ...
    function recoverERC20(address tokenAddress, uint256 amount) external onlyOwner {
        ...
        require(IERC20(tokenAddress).transfer(owner(), amount), "Token recovery failed");
    }
}
